  ...
  useEffect(() => {
    const checkAuthAndRedirect = async () => {
      try {
        ...
        // Prevent redirect loops by checking if we came from callback
        const referrer = document.referrer
        if (referrer.includes('/chat/callback')) {
          console.log('Redirected from callback, avoiding potential loop')
          // Add a small delay to ensure callback processing is complete
        ...
        console.log('User not authenticated, showing sign in:', error)
      }
